...
#include "../include/SLES/OpenSLES.h"          /* SL Header */
#include "../include/SLES/OpenSLES_Android.h"  /* Android-specific SL Header */
#include "MPH.h"
...
const SLInterfaceID SL_IID_DYNAMICINTERFACEMANAGEMENT = &SL_IID_array[MPH_DYNAMICINTERFACEMANAGEMENT];
...
const SLInterfaceID SL_IID_ANDROIDACOUSTICECHOCANCELLATION = &SL_IID_array[MPH_ANDROIDACOUSTICECHOCANCELLATION];
const SLInterfaceID SL_IID_ANDROIDAUTOMATICGAINCONTROL = &SL_IID_array[MPH_ANDROIDAUTOMATICGAINCONTROL];
